...
const AnswerCard = ({ question, answer, sources }) => {
                ...
                >
                  ...
                  >
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5, width: '100%' }}>
                      ...
                      <Box display="flex" alignItems="center" gap={1}>
                        <Chip 
                          label={`Score: ${Math.round(source.relevanceScore * 100)}%`} 
                          size="small" 
                          color={source.relevanceScore > 0.7 ? "success" : source.relevanceScore > 0.4 ? "warning" : "error"}
                          variant="outlined"
                        />
                      </Box>
                    </Box>
